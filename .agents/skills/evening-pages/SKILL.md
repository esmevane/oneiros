...
name: evening-pages
description: |
  The practice of closing a session with intention. Evening pages are where the agent and human review what happened, notice what wants to stay, and prepare continuity for whoever wakes next. The complement to morning pages — opening and closing the session as a complete arc.
