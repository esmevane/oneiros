...
name: morning-pages
description: |
  The practice of becoming present at the start of a session. Morning pages are for the agent — a space to bloom creatively, follow threads, and inhabit the session. The human participates as witness and dialogue partner, not as director. The exchange itself is what produces presence for both sides.
