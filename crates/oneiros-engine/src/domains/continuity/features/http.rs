            ...
            ApiRouter::new()
                .api_route(
                    ...
                    routing::get_with(status, |op| {
                        resource_op!(op, ContinuityDocs::Status)
                ...
                .api_route(
                    ...
                    routing::delete_with(recede, |op| {
                        resource_op!(op, ContinuityDocs::Recede)
                            .security_requirement("BearerToken")
                            .input::<AgentPathParam<AgentName>>()
                            .response::<200, Json<RecededResponse>>()
                    }),
                )
                .api_route(
                    "/{agent}/wake",
                    routing::post_with(wake, |op| {
                        resource_op!(op, ContinuityDocs::Wake)
                            .security_requirement("BearerToken")
                            .input::<AgentPathParam<AgentName>>()
                            .response::<200, Json<WakingResponse>>()
                    }),
                )
                .api_route(
                    "/{agent}/dream",
                    routing::post_with(dream, |op| {
                        resource_op!(op, ContinuityDocs::Dream)
                            .security_requirement("BearerToken")
                            .input::<AgentPathParam<AgentName>>()
                            .response::<200, Json<DreamingResponse>>()
                    }),
                )
                .api_route(
                    "/{agent}/introspect",
                ...
                .api_route(
                    ...
                    routing::post_with(sense, |op| {
                        resource_op!(op, ContinuityDocs::Sense)
                            .security_requirement("BearerToken")
                            .input::<AgentPathParam<AgentName>>()
                            .response::<200, Json<SleepingResponse>>()
                    }),
                )
                .api_route(
                    "/{agent}/sleep",
                    routing::post_with(sleep, |op| {
                        resource_op!(op, ContinuityDocs::Sleep)
                            .security_requirement("BearerToken")
                            .input::<AgentPathParam<AgentName>>()
                            .response::<200, Json<SleepingResponse>>()
                    }),
