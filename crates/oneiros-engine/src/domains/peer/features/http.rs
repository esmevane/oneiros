            ...
            ApiRouter::<ServerState>::new()
                .api_route(
                    ...
                    routing::get_with(list, |op| {
                        resource_op!(op, PeerDocs::List).response::<200, Json<PeersResponse>>()
                    })
                    .post_with(add, |op| {
                ...
                .api_route(
                    ...
                    routing::get_with(show, |op| {
                        resource_op!(op, PeerDocs::Show)
                            .input::<IdPathParam<PeerId>>()
                            .response::<200, Json<PeerFoundResponse>>()
                    })
                    .delete_with(remove, |op| {
                        resource_op!(op, PeerDocs::Remove)
                            .response::<200, Json<PeerRemovedResponse>>()
                    }),
                ),
        )
    }
