...
use crate::tests::acceptance::harness::assert_response;
...
async fn with_persona<B: Backend>() -> Result<Harness<B>, Box<dyn core::error::Error>> {
    ...
    harness
        ...
        .assert_json(assert_response!(Responses::Persona(
...
pub(crate) async fn list_empty<B: Backend>() -> TestResult {
    ...
    harness
        .query("agent list")
        .assert_json(assert_response!(Responses::Agent(AgentResponse::NoAgents)))
        .await
}
